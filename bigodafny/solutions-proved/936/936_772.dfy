...
// Each `output + IntToString(x)` is charged 1 by the digit-string exception,
// and each `output + " "`/`output + "\n"` is charged 1 for its literal
// length, so a branch's four concatenations cost O(1) regardless of how
