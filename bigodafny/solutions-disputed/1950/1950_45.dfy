...
//
//   gate            : validate.py records `fail`  (7/42 tests)
...
//   genuine failures: at least 16 of the 23 runnable tests. The Dafny
//                     passes 7; the Python through the same round-trip
//                     passes 23.
//   cause           : translation
