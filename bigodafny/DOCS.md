...
| complexity proved | 293 rows, 295 files, all verify, zero `assume` |
| campaign pass rate | 261 of 348 drawn rows, 75% — `data/prove_stats.md` |
...
`solutions-proved/` is **not** part of that partition. It holds 295 instrumented
